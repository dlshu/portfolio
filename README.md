...
- ### Spatial Completion of Turbulent Data Using Deep Generative Models* ([paper](https://arxiv.org/abs/2402.17185) | code)
...
(* code will be available after paper published)
...
(* The face-swapping model is adopted from the work by A. Siarohin et al. The driving video below was made by the courtesy of [Mitchell Fogelson](http://www.mitchellfogelson.com/).)
